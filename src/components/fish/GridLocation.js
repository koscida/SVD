...
function GridLocation({showGridDisplay, displayFish, seasonName, seasonWeather, filteredWeatherNames, caughtFish, handleCaught}) {
	...
	const GridHeader = () => {
		...
		return <>
			...
			<div className={cellClasses} style={{gridRowStart: 1, gridRowEnd: 3}}><p>Type</p></div>
			<div className={cellClasses} style={{gridRowStart: 1, gridRowEnd: 3}}><p>Tool</p></div>
	...
	return <div 
		...
		style={{gridTemplateColumns: '100px repeat(3, auto) repeat(' + allLocationsLen + ', auto)'}}>
